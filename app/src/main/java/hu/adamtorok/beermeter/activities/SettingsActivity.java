...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            pClearScoreboard = findPreference("pref_clear_scoreboard");
            pClearScoreboard.setOnPreferenceClickListener(this);
        }
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            if( preference.equals(pClearScoreboard) ) {
